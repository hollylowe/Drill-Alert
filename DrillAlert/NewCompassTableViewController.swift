//
//  NewCompassTableViewController.swift
//  DrillAlert
//
...
class NewCompassTableViewController: UITableViewController {
    ...
    class func storyboardIdentifier() -> String! {
        return "NewCompassTableViewController"
    }
